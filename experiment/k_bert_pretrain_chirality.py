...
from experiment.my_nn import collate_pretrain_data, EarlyStopping, run_a_contrastive_pretrain_epoch, \
...
args['task_name'] = 'k_bert_chirality'
args['pretrain_data_path'] = '/apdcephfs/private_zhenxingwu/pretrain/data/BERT_maccs_data/chirality_pretrain_maccs'
